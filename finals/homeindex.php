                        ...
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                ...
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                    <a class="btn btn-outline-light btn-lg px-4 custom-hover" href="#!">Learn More</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="row gx-5 row-cols-1 row-cols-md-2">
                                <div class="col mb-5 h-100">
                                    ...
                                    <h2 class="h5">73 Years of Service</h2>
                                ...
                                <div class="col mb-5 h-100">
                                    ...
                                    <h2 class="h5">42 Years in the Philippines</h2>
                                ...
                                <div class="col mb-5 mb-md-0 h-100">
                                    ...
                                    <h2 class="h5">700+ Stores Nationwide</h2>
                                ...
                                <div class="col h-100">
                                    ...
                                    <h2 class="h5">Commited to Innovation</h2>
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-10 col-xl-7">
                            <div class="text-center">
                                <div class="fs-4 mb-4 fst-italic">"Time to make the donuts!"</div>
                                <div class="d-flex align-items-center justify-content-center">
                                    <img class="rounded-circle me-3" src="images/dunkindonut/fredthebaker.webp" alt="..." style="width: 40px; height: 40px;"/>
                                    <div class="fw-bold">
                                        Fred the Baker
                                        <span class="fw-bold text-primary mx-1">/</span>
                                        sleepy-eyed ambassador
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container px-5 my-5 ">
                    <div class="row gx-5 ">
                        ...
                        <div class="col-lg-7 mb-5 d-flex flex-column justify-content-center ps-5">
                            ...
                            <a href="#" class="btn btn-primary btnprimary">EXLORE MENU</a>
                        </div>
                    </div>
                    <!-- Call to action-->
